...
public class ItemsInitializer {
    public static void initialize(Configuration config) {
        ...
        PVRegistry.register(prefixName(Constants.NETHERITE_TIER, Constants.NAME_ITEM_GRINDING_GEARSET), PVItems.NETHERITE_GRINDING_GEARSET = new GrindingGearsetItem(ToolMaterials.NETHERITE));
        ...
        PVRegistry.register(prefixName(Constants.NETHERITE_TIER, Constants.NAME_ITEM_PRINTING_PLATEN), PVItems.NETHERITE_PRINTING_PLATEN = new PrintingPlatenItem(ToolMaterials.NETHERITE));
